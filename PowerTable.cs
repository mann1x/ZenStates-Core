...
namespace ZenStates.Core
{
    public class PowerTable : INotifyPropertyChanged
    {
        ...
        private static readonly PowerTableDef PowerTables = new PowerTableDef
        {
            ...
            { 0x380804, 0x8A4, 0xC0, 0xC8, 0xCC, 0xB4, 0x224, 0x228, 0x22C, 0x24C, -1, 0x008, 0x020, 0x010, 0 },
            { 0x380805, 0x8F0, 0xC0, 0xC8, 0xCC, 0xB4, 0x224, 0x228, 0x22C, 0x2B0, -1, 0x008, 0x020, 0x010, 0 },
            { 0x380904, 0x5A4, 0xC0, 0xC8, 0xCC, 0xB4, 0x224, 0x228, 0x22C, 0x2A4, -1, 0x008, 0x020, 0x010, 0 },
            { 0x380905, 0x5D0, 0xC0, 0xC8, 0xCC, 0xB4, 0x224, 0x228, 0x22C, 0x2B0, -1, 0x008, 0x020, 0x010, 0 },

            // Generic Zen 3 CPU (latest known)
            { 0x000300, 0x948, 0xC0, 0xC8, 0xCC, 0xB4, 0x224, 0x228, 0x22C, -1, -1, 0x008, 0x020, 0x010, 0 },
